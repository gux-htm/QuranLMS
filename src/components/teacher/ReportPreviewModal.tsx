        ...
        <div className="space-y-4 rounded-md bg-white p-5 text-sm sm:p-6">
          <div className="border-b border-line pb-3">
            <div className="font-display text-lg font-semibold text-green-800">
              Your Tajweed Report â€” {dateLabel}
            </div>
            <div className="mt-0.5 text-xs text-ink/50">
              To: {report.recipient} â€¢ TILP Daily Report
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-line p-3 text-center">
                <div className="font-display text-xl font-semibold text-green-700">{report.grade ?? 'â€”'}</div>
          ...
          {report.mistakesCount > 0 && (
            <div>
              ...
              <p className="rounded-xl border border-line bg-paper p-3 text-ink/70">
          ...
          <div>
            ...
            <p className="rounded-xl border border-line bg-paper p-3 font-medium text-ink">{report.nextLesson}</p>
          </div>
          ...
          <div>
            ...
            <p className="rounded-xl border border-line bg-paper p-3 italic text-ink/70">
              â€œ{report.teacherMessage}â€
            </p>
          </div>

          <div className="border-t border-line pt-3 text-xs text-ink/45">
            Salam, {studentName.split(' ')[0]} â€” keep going!
            <br />
