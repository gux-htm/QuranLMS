...
import { BookOpenText, LayoutGrid, Calendar, BarChart3, Award, LogOut, Menu, X } from 'lucide-react'
          ...
          <div className="flex items-center justify-between gap-4 px-4 py-3 sm:px-6">
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <div className="text-sm font-medium text-ink">{CURRENT_STUDENT.name}</div>
                <div className="text-xs text-ink/50">Rank #{CURRENT_STUDENT.rank}</div>
              </div>
              <button
                onClick={() => navigate('/')}
