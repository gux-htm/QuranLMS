...
const studentItems = [
  { icon: BookOpen, title: 'New lesson assigned', description: 'Juz 1, Pages 7â€“9 assigned by your teacher', time: '1h ago', unread: true, color: 'text-green-700' },
  { icon: Award, title: 'Badge unlocked', description: 'You earned â€œBronze Streakâ€', time: '3d ago', unread: false, color: 'text-gold-700' },
]
